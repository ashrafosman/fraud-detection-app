...
# MAGIC %md
# MAGIC # ⚠️ DEMO NOTEBOOK - NOT PART OF PRODUCTION APPLICATION
# MAGIC
# MAGIC > **📢 IMPORTANT NOTICE:**  
# MAGIC > This notebook is an **independent educational demo** and is **NOT integrated** with the main Streamlit application or production workflow.
# MAGIC >
# MAGIC > **Purpose:** Interactive demonstration of LangGraph ReAct agent concepts for learning and exploration only.
# MAGIC >
# MAGIC > **Status:** 🚧 Work in progress - for reference and experimentation purposes.
# MAGIC >
# MAGIC > **For Production Use:** See `app/utils/fraud_agent.py` for the actual production implementation used in the Streamlit dashboard.
# MAGIC >
# MAGIC > ---
# MAGIC
...
# MAGIC %md
# MAGIC # ✨✨✨ VERSION 2.1 - CREATED DEC 14, 2024 ✨✨✨
...
# MAGIC
# MAGIC **📅 Last Updated:** December 14, 2024
# MAGIC **🔧 Version:** 2.1 - WITH ARCHITECTURE DIAGRAMS
...
# MAGIC - Strong tool-calling abilities needed for ReAct claims_analysis
...
WAREHOUSE_ID = "148ccb90800933a1"  # ← UPDATE THIS: Your SQL Warehouse ID
INDEX_NAME = f"{CATALOG}.{SCHEMA}.knowledge_base_index"  # Vector search index
GENIE_SPACE_ID = "01f0d3b893281964829ca73bcfa4d7c7"  # ← UPDATE THIS: Copy from Genie UI after creating space

# LLM Configuration
# 🚨 CRITICAL: Use Claude Sonnet 4 for production claims_analysis with function calling
# 
# LESSON LEARNED:
...
if len(agent_tools_unique) < 4:
    ...
    print(f"   ✅ Agent skipped: {set(['classify_claim', 'extract_metadata', 'search_knowledge', 'query_historical']) - set(agent_tools_unique)}")
